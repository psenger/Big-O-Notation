package com.cngrgroup.BigONotation;
...
/**
 * <p>
 *     ADAPTED FROM http://www.newthinktank.com/2013/03/big-o-notations/
 *     Derek Banas
 * </p>
 *
 * @author psenger
...
public class BigONotation {
    ...
    public void bubbleSort() {
        ...
        for (int i = arraySize - 1; i > 1; i--)
            for (int j = 0; j < i; j++) if (theArray[j] > theArray[j + 1]) swapValues(j, j + 1);
        endTime = System.currentTimeMillis();
        System.out.println("Bubble Sort Took " + (endTime - startTime));
    }

    // O (log N) Occurs when the data being used is decreased by roughly 50% each time through the algorithm. The
